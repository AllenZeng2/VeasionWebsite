...
public class ImageOperate {
     ...
     * @throws Exception
     */
    public FaceResponse imageRecognition(String imageUrl, byte[] fileByte, String image_base64) throws Exception {
     ...
     * @throws Exception
     */
    public FaceResponse textRecognition(String imageUrl, byte[] fileByte, String image_base64) throws Exception {
        HashMap<String, String> map = new HashMap<>();
        HashMap<String, byte[]> fileMap = new HashMap<>();
        map.put(Key.KEY_FOR_APIKEY, apiKey);
        map.put(Key.KEY_FOR_APISECRET, apiSecret);
