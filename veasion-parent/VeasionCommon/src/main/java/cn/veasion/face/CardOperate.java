...
public class CardOperate {
     ...
     * @throws Exception
     */
    public FaceResponse ocrIDcard(String imageUrl, byte[] fileByte, String image_base64, int legality) throws Exception {
     ...
     * @throws Exception
     */
    public FaceResponse ocrDriverLicense(String imageUrl, byte[] fileByte, String image_base64) throws Exception {
     ...
     * @throws Exception
     */
    public FaceResponse ocrVehicleLicense(String imageUrl, byte[] fileByte, String image_base64) throws Exception {
