		...
		$.ajax({
			...
			success:function(data){
				if(data){
					...
					var win=window.top.window.f_open("admin", "${pageContext.request.contextPath}/webpage/admin/desktop/admin.jsp", "后台管理", "${pageContext.request.contextPath}/resources/images/icon_tool.png", 1100, 550, true);
					win.show();
					obj.close();
				}
			},
