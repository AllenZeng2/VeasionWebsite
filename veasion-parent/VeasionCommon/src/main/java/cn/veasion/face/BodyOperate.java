...
public class BodyOperate {
     ...
     * @throws Exception
     */
    public FaceResponse HumanBodyDetect(String imageUrl, byte[] fileByte, String image_base64, String return_attributes) throws Exception {
     ...
     * @throws Exception
     */
    public FaceResponse HumanBodySegment(String imageUrl, byte[] fileByte, String image_base64) throws Exception {
