...
<script src="${pageContext.request.contextPath}/resources/js/jquery/ligerUI/js/ligerui.all.js" type="text/javascript"></script>
<style type="text/css">
...
#pageloading {position: absolute;left: 0px;top: 0px;background: white url('${pageContext.request.contextPath}/resources/images/loading.gif') no-repeat center;width: 100%;height: 100%;z-index: 99999;}
...
<script type="text/javascript">
	var indexdata = [ {
		...
		children : [ 
			{
				text : "样式管理",
				url : "${pageContext.request.contextPath}/webpage/admin/desktop/styleList.jsp"
			},
			{
				text : "图标管理",
				url : "${pageContext.request.contextPath}/webpage/admin/desktop/iconList.jsp"
			},
			{
				text : "链接管理",
				url : "${pageContext.request.contextPath}/webpage/admin/desktop/urlList.jsp"
			},
			{
				text : "字典管理",
				url : "${pageContext.request.contextPath}/webpage/admin/desktop/dictionaryList.jsp"
			}
		]
	},{
		text : 'user',
		...
		children : [ 
			{
				text : "来访记录",
				url : "${pageContext.request.contextPath}/webpage/admin/desktop/ipList.jsp"
			}
		]
	} ];
