		...
		$.ajax({
			...
			success : function(data) {
				...
				if(data==null || links==null || links.length<1){
					links=[{id:"icon_notepad", url:"${pageContext.request.contextPath}/webpage/home/desktop/notepad.jsp", icon:"${pageContext.request.contextPath}/webpage/resources/images/icon_notepad.png", title:"记事本", showMax:false}];
				}
				// 创建图标
				createIcons();
				// 背景
